{
  ...
  let 
    ...
    nixvimLib = nixvim.lib.${systemSettings.system};
    nixvim' = nixvim.legacyPackages.${systemSettings.system};

    nixvimModule = {
      inherit pkgs;
      module = import ./user/modules/nixvim; # Ensure you have a configuration file here
      extraSpecialArgs = {
        # inherit (inputs) foo; # Example: If you need to pass additional args
      };
    };
  ...
  in {
    ...
    # --- NIXVIM Setup ---
    packages.${systemSettings.system}.nvim = nvim;
